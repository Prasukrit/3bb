                                            ...
                                            <div class="margin-side">
                                                <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control input-sm" name="type" id="type"  ?>
                                                                    ...
                                                                    ?>>--กรุณาเลือก--</option>
                                                                    <option value="คอนโด" <?php
                                                                    if ($row['type'] == 'คอนโด') {
                                                                        echo "selected='selected'";
                                                                    }
                                                                    ?>>คอนโด</option>
                                                                    <option value="หมู่บ้านจัดสรรค์" <?php
                                                                            if ($row['type'] == 'หมู่บ้านจัดสรรค์') {
                                                                                echo "selected='selected'";
                                                                            }
                                                                            ?>>หมู่บ้านจัดสรรค์</option>
                                                                    <option value="อพาทเม้น" <?php
                                                                    if ($row['type'] == 'อพาทเม้น') {
                                                                        echo "selected='selected'";
                                                                    }
                                                                    ?>>อพาทเม้น</option>
                                                                    <option value="หอพักเอกชน" <?php
                                                                    if ($row['type'] == 'หอพักเอกชน') {
                                                                        echo "selected='selected'";
                                                                    }
                                                                    ?>>หอพักเอกชน</option>
                                                                    <option value="บ้านเดี่ยว" <?php
                                                                    if ($row['type'] == 'บ้านเดี่ยว') {
                                                                        echo "selected='selected'";
                                                                    }
                                                                    ?>>บ้านเดี่ยว</option>
                                                                </select>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control input-md" type="text" name="project_name" placeholder="ระบุชื่อโครงการ" value="<?php echo $row['project_name']; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="">จำนวนหน่วย</label>
                                                                <input class="form-control input-sm" type="text" name="project_unit" placeholder="ระบุหน่วย เช่น 300 หลัง" value="<?php echo $row['project_unit']; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="">บริษัทผู้สร้าง</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="">เลขที่/ซอย/ถนน</label>
                                                                <textarea style="text-indent:5px;" class="form-control" name="address" id="" cols="30" rows="2" placeholder="ระบุที่อยู่ เช่น 14/6 / หมู่ 3 / ถนนราชพฤกษ์"><?php echo trim($row['address']); ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control input-sm" type="text" name="contact_name" placeholder="ระบุชื่อ" value="<?php echo $row['contact_name']; ?>" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control input-sm" type="text" name="contact_tel1" placeholder="ระบุเบอร์โทร" value="<?php echo $row['contact_tel1']; ?>" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>เบอร์มือถือ</label>
                                                                <input class="form-control input-sm" type="text" name="contact_tel2" placeholder="ระบุเบอร์โทร" value="<?php echo $row['contact_tel2']; ?>" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <ul class="nav nav-tabs">
                                                        <li role="presentation" class="active">
                                                            <a href="#open" data-toggle="tab" > <i class="glyphicon glyphicon-map-marker" style="color:green;" ></i>
                                                                &nbsp;&nbsp;ตำแหน่งที่ตั้ง
                                                            </a>
                                                        </li>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input class="form-control input-sm" type="text" name="sale_name" placeholder="ชื่อผู้รับผิดชอบโครงการ" readonly <?php
...
<!--                                                        <div class="tab-pane fade" id="close">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="col-lg-12" for="">สถานะโครงการ</label>
                                                                <div class="col-lg-4">
                                                                    <div class="radio">
                                                                        <label>
                                                                            <input type="radio" name="status" id="status" value="0" <?php if ($row["status"] == 0) { echo "checked=''";} ?>>
                                                                            <span style="color: #00CC00">เปิดให้บริการ</span>
                                                                        </label>
                                                                    </div>
                                                                </div>	
                                                                <div class="col-lg-4">
                                                                    <div class="radio">
                                                                        <label>
                                                                            ...
                                                                            <span style="color: red">ปิดการให้บริการ</span>
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            </div>
